...
func (client *FtxClient) placeOrder(clientId string, market string, side string, price float64, _type string, size float64, reduce bool, post bool, ioc bool) (*http.Response, error) {
	newOrder := OrderParam{Market: market, Side: side, Price: price, Type: _type, Size: size, ReduceOnly: reduce, ClientId: clientId, PostOnly: post, Ioc: ioc}
