...
func place(clientId string, market string, side string, price float64, _type string, size float64, reduce bool, post bool, ioc bool) error {
...
func loadBaseConfigAndAssign(file string) *Config {
